...
jsCode <- '
shinyjs.setLoaderAppearance = function(){
  $("#shiny-notification-panel").addClass("custom-loader");
  $("#shiny-notification-panel").detach().prependTo("#testloader");
  }
'
...
shinyUI(fluidPage(
  ...
  useShinyjs(),
  extendShinyjs(text = jsCode, functions = c("setLoaderAppearance")),
             ...
             tabPanel("CRUX",
                      tabsetPanel(
                        ...
                        tabPanel("Results",
                                 ...
                                 fluidRow(
                                   column(12, align="center", style='padding-top:15px',
                                          DT::dataTableOutput("CRUXcoverageResults") %>% withSpinner(color="#000000"),
                        ...
                        tabPanel("Summary Results",
                                 ...
                                 fluidRow(
                                   column(12, align="center", style='padding-top:15px',
                                          DT::dataTableOutput("CRUXSummaryResults") %>% withSpinner(color="#777777"),
             ...
             tabPanel("NCBI",          #NCBI Tab    
                      ...
                      tabsetPanel(
                        ...
                        tabPanel("Results",
                                 ...
                                 fluidRow(
                                   column(12, align="center", style='padding-top:15px',
                                          tags$div(id="testloader"),
                                          DT::dataTableOutput("NCBIcoverageResults") %>% withSpinner(color="orange"),
                        ...
                        tabPanel("Summary Results",
                                 ...
                                 fluidRow(
                                   column(12, align="center", style='padding-top:15px',
                                          DT::dataTableOutput("NCBISummaryResults") %>% withSpinner(color="purple"),
             ...
             tabPanel("Full Genome Search",
                      tabsetPanel(
                        ...
                        tabPanel("Results",
                                 ...
                                 fluidRow(
                                   column(12, align="center", style='padding-top:15px',
                                          DT::dataTableOutput("genomeResults") %>% withSpinner(color="brown"),
