  ...
  navbarPage("Reference Sequence Browser",
             ...
             tabPanel("BOLD",
                      tabsetPanel(
                        ...
                        tabPanel("Absent/Invalid Metadata",
                          column(12, align="center", offset=0,style='padding-top:15px',
                            div(id = "bold_species_not_found_panel",
                              titlePanel("Absent or Invalid Metadata in BOLD"),
                              p("This table lists organisms that were either not found in the BOLD database or yielded invalid results. 
                                If an organism does not appear in this table, it means there are results available in the BOLD database for it. 
                                Should the name of an organism in the table be appended with the (invalid) keyword, 
                                we recommend conducting a manual search to check if the issue stems from incorrect metadata returned by the BOLD database. 
                                Furthermore, please note that the results displayed in this table are unaffected by the filter settings.")
                              ),
