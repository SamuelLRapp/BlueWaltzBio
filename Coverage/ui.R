                                 ...
                                 fluidRow(
                                   ...
                                   sidebarPanel(
                                     ...
                                     bsPopover(id="barcodeListHelp", title="Help", content = paste0(
                                       ...
                                       "<p>Cytochrome oxidase subunit 1, for example, may be found under the names <i>COI</i>, <i>CO1</i>, <i>COXI</i>, and <i>COX1</i>.</p>"), trigger="click" ),
                                     ...
                                     bsPopover(id="searchOptGeneHelp", 
                                               title="Help", 
                                               content=paste0('<p>If this box is checked, the programming package <i>Taxize</i> will:</p>',
                                                              '<ol>',
