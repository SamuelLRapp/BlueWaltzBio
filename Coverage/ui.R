                                 ...
                                 fluidRow(
                                   ...
                                   sidebarPanel(
                                     ...
                                     bsPopover(id="barcodeListHelp", title="Help", content = paste0(
                                       ...
                                       "<p>Common genes used as organism barcodes include: CO1, 16S, 18S, rbcL, matK, ITS, FITS, trnL, Vert12S.</p>",
                                       "<p>Note: naming conventions in NCBI may vary, thus one gene may be found under multiple names.</p>",
                                       "<p>Cytochrome Oxidase subunit 1, for example, may be found under the names COI, CO1, COXI, and COX1.</p>"), trigger="click" ),
                                     ...
                                     checkboxInput(inputId = "NCBISearchOptionGene", label = list("Search by the [GENE] Metadata field", tags$a(id="searchOptGeneHelp",icon("question-circle")) ), value = TRUE),
                                     bsPopover(id="searchOptGeneHelp", 
                                               title="Help", 
                                               content=paste0('<p>If this box is checked, the programming package &#39;Taxize&#39; will:</p>',
                                                              '<ol>',
                                                              '<li><p>Spell check each of your organisms’ names before searching the NCBI database&#10;</p></li>',
                                                              '<li><p>Check if you have the most up to date organism names, and replaces your search term if not</p></li>',
                                                              '<li><p>Add synonyms for the organism(s) listed to assist in finding more entries. Example: Homo sapien with the &#39;Check spelling and synonyms for organism names&#39; box checked will search both &#39;Homo sapien&#39; and &#39;Homo sapien varitus&#39;</p></li>',
                                                              '</ol>',
                                                              '<p>Note: for a full list of the data sources that Taxize references for proper nomenclature, see the Taxize github <a href="https://github.com/ropensci/taxize" target="_blank_">here</a>.</p>',
                                                              '<p>(Click <i class="fa fa-question-circle"></i> again to close)</p>'
                                               ), 
                                               trigger="click"),
                                     checkboxInput(inputId = "seqLengthOption", label = list("Set minimum sequence lengths(by marker)", tags$a(id="minSeqLenHelp",icon("question-circle"))) ),
                                     bsPopover(
                                               id="minSeqLenHelp",
                                               title="Help",
                                               content=paste0(
                                                 "<p>When searching for barcodes, a NCBI database record may only be useful for identifying an organism if it is above a certain base pair length. This varies from gene to gene and thus the tool allows each gene’s minimum base pair length to be specified individually.</p>",
                                                 "<p>By checking this box users can set a minimum base pair length filter. Entries that are below the specified base pair length, won’t appear in the coverage matrix output.</p>",
                                                 '<p>(Click <i class="fa fa-question-circle"></i> again to close)</p>'),
                                              trigger="click"
                                     ),
